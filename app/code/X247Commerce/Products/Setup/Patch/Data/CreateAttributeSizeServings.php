...
class CreateAttributeSizeServings implements DataPatchInterface
{
    ...
    public function apply()
    {
        ...
        if( !$eavSetup->getAttributeId(\Magento\Catalog\Model\Product::ENTITY, 'size_servings')) {
            $eavSetup->removeAttribute(\Magento\Catalog\Model\Product::ENTITY, 'size_servings');
        }

        $eavSetup->addAttribute(\Magento\Catalog\Model\Product::ENTITY, 'size_servings', [
           'type' => 'int',
           'label' => 'Size / Servings',
           'input' => 'select',
    ...
    public function convertAttributeToSwatches() {
        $attribute = $this->eavConfig->getAttribute('catalog_product', 'size_servings');
        if (!$attribute) {
            return;
        }
