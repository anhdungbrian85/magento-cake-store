...
class CreateAttributeColor implements DataPatchInterface
{
    ...
    public function apply()
    {
        ...
        if( !$eavSetup->getAttributeId(\Magento\Catalog\Model\Product::ENTITY, 'color')) {
            $eavSetup->removeAttribute(\Magento\Catalog\Model\Product::ENTITY, 'color');
        }

        $eavSetup->addAttribute(\Magento\Catalog\Model\Product::ENTITY, 'color', [
           'type' => 'int',
           'label' => 'Color',
           'input' => 'select',
