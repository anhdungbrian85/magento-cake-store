...
class CreateAttributeTheme implements DataPatchInterface
{
    ...
    public function apply()
    {
        ...
        if( !$eavSetup->getAttributeId(\Magento\Catalog\Model\Product::ENTITY, 'theme')) {
            $eavSetup->removeAttribute(\Magento\Catalog\Model\Product::ENTITY, 'theme');
        }

        $eavSetup->addAttribute(\Magento\Catalog\Model\Product::ENTITY, 'theme', [
           'type' => 'int',
           'label' => 'Theme',
           'input' => 'select',
    ...
    public function convertAttributeToSwatches() {
        $attribute = $this->eavConfig->getAttribute('catalog_product', 'theme');
        if (!$attribute) {
            return;
        }
