...
class UpdateInStockStatusConfigurable extends \Magento\Catalog\Block\Adminhtml\Product\Edit\Button\Generic
{
        ...
        if ($roleId != 1) {
            if ($this->request->getParam('id') == NULL) {
                ...
                if ($product->getTypeId() == 'configurable') {
                    return [
                        'label' => __('Set Child Products In Stock'),
