    ...
    $.widget('mage.SwatchRenderer', {
        ...
        _RenderSwatchOptions: function (config, controlId) {
            var optionConfig = this.options.jsonSwatchConfig[config.id],
                ...
                countAttributes = 0,
                shapeLabel = this.options.shapeLabel,
                shapeImage = this.options.shapeImage,
                html = '';
            ...
            $.each(config.options, function (index) {
                ...
                if (type === 0) {
                    // Text
                    var textLabel = (value ? value : label);
                    var labelArray = textLabel.split('"');
                    ...
                    html += '<div class="' + optionClass + ' text" ' + attr + '><span class="option-label">' + textLabel + "</span>";

                    if ( config.code == 'size_servings' ) {
                        if ( shapeImage ) {
