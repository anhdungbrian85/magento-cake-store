    ...
    var pickupInfo = customerData.get(selectedPickupInfoKey)(),
        ...
        updateDefaultValue = function() {
            if (window.checkoutConfig.deliveryType == 0) {
                customerData.set('amasty-selected-pickup-info', {
                    am_pickup_curbside: {},
                    am_pickup_date: window.checkoutConfig.amastySelectedPickup.am_pickup_date,
                    am_pickup_store: window.checkoutConfig.amastySelectedPickup.am_pickup_store,
                    am_pickup_time: window.checkoutConfig.amastySelectedPickup.am_pickup_time
                })
            }
        };
