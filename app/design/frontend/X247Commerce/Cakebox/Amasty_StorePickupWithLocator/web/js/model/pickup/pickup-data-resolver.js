define([
    ...
    var pickupInfo = window.checkoutConfig.amastySelectedPickup,
        locationsData = function() {
            return window.checkoutConfig.amastyLocations;
        },
        indexedStores = null,
        ...
        getPickupData = function () {
            return window.checkoutConfig.amastySelectedPickup;
        },
    ...
    /**
         ...
         * @returns {*}
         */
    var getCartParamUnsanitizedHtml = function (name) {
    ...
    return {
        ...
        getDataByKey: function (key) {
            ...
            if (key == 'am_pickup_date') {
                return this.dateData();
            }
            if (key == 'am_pickup_store') {
                return this.storeId();
            }
            if (key == 'am_pickup_curbside') {
                return this.curbsideData();
            }
            if (key == 'am_pickup_curbside') {
                return this.curbsideData();
            }
