            ...
            return $.ajax({
                ...
                success: function (response) {
                    try {
                        ...
                        var amShopbyButton = '.am_shopby_apply_filters .amshopby-button',
                            buttonApplyFilter = '.filter-sidebar .apply-filter';

                        if ($(amShopbyButton).prop('disabled')) {
                            $(buttonApplyFilter).prop('disabled',true);
                        } else {
                            $(buttonApplyFilter).prop('disabled',false);
                            $(document).on('click', buttonApplyFilter ,function() {
